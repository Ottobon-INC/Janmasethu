...
const Home = () => {
  ...
  return (
    <>
      ...
      <section className="hero-section relative overflow-hidden -mt-20 pt-20">
        ...
        <div className="video-container">
          <video
            ...
            preload="auto"
            poster="/babyFeet.jpg"
            aria-label={lang === 'hi' ? 'जन्म सेतु परिवार यात्रा वीडियो' : lang === 'te' ? 'జన్మ సేతు కుటుంబ ప్రయాణ వీడియో' : 'JanmaSethu Family Journey Video'}
        ...
        <div className="hero-content">
          <div className="container mx-auto px-4 py-16">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 card-shadow">
            ...
            {/* Hero Title */}
            <h1
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-serif mb-6 leading-relaxed text-center"
            ...
            {/* Hero Subtitle */}
            <p
              className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto text-center"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/sakhi/try">
                <Button
                  className="gradient-button text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-lg transition-all duration-300 group overflow-hidden relative backdrop-blur-sm"
              ...
              <Link href="/clinic">
                <Button
                  variant="outline"
                  className="bg-white/90 backdrop-blur-sm text-foreground px-8 py-4 rounded-full font-semibold text-lg border-white/30 hover:shadow-lg transition-all duration-300 group overflow-hidden relative"
